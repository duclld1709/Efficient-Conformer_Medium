...
class ConformerEncoder(nn.Module):
    ...
    def __init__(self, params):
        ...
        # Input Type (waveform or pre-computed features)
        self.input_type = params.get("input_type", "waveform")
        if self.input_type not in ["waveform", "features"]:
            raise ValueError("encoder_params['input_type'] must be 'waveform' or 'features'")
